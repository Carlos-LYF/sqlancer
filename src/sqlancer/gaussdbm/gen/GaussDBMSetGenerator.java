...
public class GaussDBMSetGenerator {
    ...
    public GaussDBMSetGenerator(Randomly r, MainOptions options) {
        this.r = r;
        this.isSingleThreaded = options.getNumberConcurrentThreads() == 1;
    }

    public static SQLQueryAdapter set(GaussDBMGlobalState globalState) {
        return new GaussDBMSetGenerator(globalState.getRandomly(), globalState.getOptions()).get();
    }
    ...
    private enum Action {
        ...
        /* disabled as a workaround for https://bugs.GaussDBM.com/bug.php?id=95987 */
        ...
        OPTIMIZER_SWITCH("optimizer_switch", Action::getOptimizerSwitchConfiguration, Scope.GLOBAL, Scope.SESSION), //
        ...
        RANGE_OPTIMIZER_MAX_MEM_SIZE("range_optimizer_max_mem_size", (r) -> r.getLong(0, Long.MAX_VALUE), Scope.GLOBAL,
                Scope.SESSION),
        /*
         * Removed Scope.GLOBAL as a workaround for https://bugs.GaussDBM.com/bug.php?id=95985
         */
        ...
        /*
         * sort_buffer_size is commented out as a workaround for https://bugs.GaussDBM.com/bug.php?id=95969
         */
        ...
        // TODO: https://dev.GaussDBM.com/doc/refman/8.0/en/switchable-optimizations.html

        private final String name;
        private final Function<Randomly, Object> prod;
        ...
        /*
         * @see https://dev.GaussDBM.com/doc/refman/8.0/en/switchable-optimizations.html
         */
